...
const double NetworkSimulator::STDP_WINDOW = 100.0;
const double NetworkSimulator::timestep = 0.02; // timestep for solving neuronal dynamics in ms
const double NetworkSimulator::network_update_frequency = 0.1; // frequency of communication between processes in ms
const double NetworkSimulator::trial_duration = 500.0; // 
